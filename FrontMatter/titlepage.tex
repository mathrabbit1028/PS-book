...
\begin{titlepage}
    ...
    \colorbox{black!5}{
        ...
        \parbox[t]{0.975\textwidth}{%
            ...
            \parbox[t]{0.95\textwidth}{%
                ...
                Fundamentals of Problem Solving \\[7.5pt]
                \large\bf 79 algorithms for OI
                \vspace{0.75cm}
            }
        }
    }
    ...
    \parbox[t]{0.95\textwidth}{%
        ...
        \raggedleft
        \textcopyright\:{Mingeon Joung\textsuperscript{\textdagger}\\
            Donghyun Gu\textsuperscript{\textdagger}}\\[4pt]
        
        % Display the superscript \textdagger symbol and authors' affiliations.
        \normalsize\textsuperscript{\textdagger} SSHS, Seoul, South Korea\\
